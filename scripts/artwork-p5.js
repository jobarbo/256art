...
function INIT(seed) {
	scl1 = random([0.001, 0.0011, 0.0012, 0.0013, 0.0014, 0.0015, 0.0016]);
	scl2 = scl1;

	ang1 = int(random([640, 1280]));
	ang2 = int(random([640, 1280]));
...
class Mover {
	constructor(x, y, hue, scl1, scl2, ang1, ang2, xMin, xMax, yMin, yMax, seed) {
		...
		this.xRandSkipper = 0;
		this.yRandSkipper = 0;
		this.xRandSkipperVal = features.strokestyle === 'thin' ? 0 : features.strokestyle === 'bold' ? 2 : 1;
		this.yRandSkipperVal = features.strokestyle === 'thin' ? 0 : features.strokestyle === 'bold' ? 2 : 1;
		this.xMin = xMin;
		this.xMax = xMax;
		this.yMin = yMin;
		this.yMax = yMax;
