...
class Mover {
	...
	move() {
		...
		this.xRandDivider = random([0.1, 0.25, 5, 10, 30, 50, 100]);
		this.yRandDivider = random([0.1, 0.25, 5, 10, 30, 50, 100]);
...
function superCurve(x, y, scl1, scl2, ang1, ang2, seed, octave) {
	...
	let u = mapValue(un, -0.0015, 0.15, -25, 25, true);
	let v = mapValue(vn, -0.15, 0.0015, -25, 25, true);
