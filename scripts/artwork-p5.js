...
class Mover {
	constructor(x, y, hue, scl1, scl2, ang1, ang2, xMin, xMax, yMin, yMax, seed) {
		...
		this.y = y;
		this.initHue = hue;
		this.initSat = random([0, 10, 20, 20, 20, 30, 40, 60, 80, 80, 100]);
		this.initBri =
			features.theme === 'bright' && features.colormode !== 'monochrome'
				? random([10, 20, 20, 40, 40, 60, 70, 80, 90, 100])
				: features.theme === 'bright' && features.colormode === 'monochrome'
		...
		this.xRandSkipper = 0;
		this.yRandSkipper = 0;
		this.xRandSkipperVal = features.strokestyle === 'thin' ? 0 : features.strokestyle === 'bold' ? 3 : 1;
		this.yRandSkipperVal = features.strokestyle === 'thin' ? 0 : features.strokestyle === 'bold' ? 3 : 1;
		this.xMin = xMin;
		this.xMax = xMax;
		this.yMin = yMin;
		this.yMax = yMax;
	...
	move() {
		...
		this.sat += mapValue(pxy, -10, 10, -1, 1, true);
...
function superCurve(x, y, scl1, scl2, ang1, ang2, seed, octave) {
	...
	let u = mapValue(un, -0.15, 0.00015, -5, 5, true);
	let v = mapValue(vn, -0.00005, 0.15, -5, 5, true);
